...
'''
2. json.loads  反序列化  字符串->数据类型
   将已编码的 JSON 字符串解码为 Python中的数据类型
...
print("loads:", object_json)  # {'name': 'RongEr', 'age': 18, 'love': 'reading'}  注意原来的双引号都变为单引号了，因为在python中，
                              # dict的底层定义默认是单引号
